# Road Natural Disaster Obstacle Detection Dataset: 19 000 images supports Yolo and VO.

# Body

Road Natural Disaster Obstacle Detection Dataset: 19,000 images, supports yolo and voc formats, including scenarios such as landslides, collapses, fallen trees, road collapses, etc. Suitable for target detection, algorithm training, research.

ordered and sent immediately upon purchase， .


Notes
landslide, fallen tree, stone, road collapse
